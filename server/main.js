...
const UUID = process.env.UUID || 'e2020d70-c4b4-4d54-a6b7-db0bbbc6bc7b';               
const DOMAIN = process.env.DOMAIN || 'hellowrlda.meteorapp.com';     

const WSPATH = process.env.WSPATH || UUID.slice(0, 8);
const SUB_PATH = process.env.SUB_PATH || 'db0bbbc6bc7b/sub';
